 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            bildSliders();
            if (document.querySelector(".comments-block__slider")) new core(".comments-block__slider", {
                ...
                loop: true,
                pagination: {
                    el: ".comments-block__pagination",
                    clickable: true
                },
                navigation: {
                    nextEl: ".comments-block__arrow-next",
                    prevEl: ".comments-block__arrow-prev"
                },
                on: {}
            });
            if (document.querySelector(".team-block__slider")) new core(".team-block__slider", {
            ...
            if (document.querySelector(".reviews-block__slider")) new core(".reviews-block__slider", {
                ...
                loop: true,
                navigation: {
                    nextEl: ".reviews-block__arrow-next",
                    prevEl: ".reviews-block__arrow-prev"
                },
                on: {}
            });
        }
